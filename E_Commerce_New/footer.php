				...
				<div class="row">
					<div class="col-md-6 col-sm-6">
						<ul class="call-email-alt">
							...
							<li><a href="#" class="callemail"><i class="uil uil-envelope-alt"></i>info@yoursite.com</a></li>
						</ul>
					</div>
					<div class="col-md-6 col-sm-6">
					...
					<div class="col-md-12">
						<div class="footer-bottom-links">
							<ul>
								...
								<li><a href="refndReturn.php">Refund & Return Policy</a></li>
							</ul>
						</div>
						<div class="copyright-text">
							<i class="uil uil-copyright"></i>Copyright 2021 <b>Organic Food Store</b> . All rights reserved
						</div>
					</div>
				</div>
			</div>
...
<!-- Mirrored from gambolthemes.net/html-items/gambo_supermarket_demo/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Jul 2020 05:58:44 GMT -->
</html>