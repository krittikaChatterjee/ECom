        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
                ...
                <?php
                            echo '<meta http-equiv="refresh" content="2;url=add_seller.php">';
                        }
                        else
                        {
                            $insert_query=mysqli_query($conn,"INSERT INTO `seller`(`name`, `email`, `password`) VALUES ('$name','$email','$enc_password')");
                            if($insert_query)
                            {
                                ?>
                                 <div class="alert alert-success alert-dismissible" role="alert">
