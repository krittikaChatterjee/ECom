      ...
      <div class="row pt-2 pb-2">
        <div class="col-sm-9">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"> Edit Delivery Location</li>
         </ol>
       </div>
     </div><!-- End Breadcrumb-->
     ...
     <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
                <?php
                $idd=base64_decode($_REQUEST['i']);
                $select_query=mysqli_query($conn,"SELECT * FROM nearest_point WHERE id='$idd'");
                    ...
                    if(isset($_POST['submitbtn']))
                    {
                       ...
                       /* $location=mysqli_real_escape_string($conn,$_POST['location']);
                        $address=mysqli_real_escape_string($conn,$_POST['address']);*/
                                ...
                                $sql = "UPDATE `nearest_point` SET `name`='$name' WHERE `id`='$idd'";
                                ...
                                <?php
                                      echo '<meta http-equiv="refresh" content="2;url=manage_location.php">';
                                  }
                                  else{
                                ?>
              ...
              <form id="personal-info" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="name" id="pin"  class="form-control" placeholder="Name"  required value="<?php echo $select_fetch['name']; ?>">
                ...
                <!--<div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="location" id="location"  class="form-control" placeholder="Location"  required value="<?php echo $select_fetch['location']; ?>">
                ...
                <!--<div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <textarea type="text" name="address" id="address"  class="form-control" placeholder="Address"  required><?php echo $select_fetch['address']; ?></textarea>
