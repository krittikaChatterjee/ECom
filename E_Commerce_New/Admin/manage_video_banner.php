  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row pt-2 pb-2">
        <div class="col-sm-9">
          <h4 class="page-title">Video Banner</h4>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="#">Video Banner</a></li>
            <li class="breadcrumb-item active" aria-current="page"> Edit Video Banner </li>
         </ol>
       </div>
     </div><!-- End Breadcrumb-->
          ...
          <div class="card">
            <div class="card-body">
                <?php
               	...
               	$fetch_post=mysqli_query($conn,"SELECT * FROM video_banner");
               	$fetct_raw_poster=mysqli_fetch_assoc($fetch_post);
               	$imh_poster=$fetct_raw_poster['banner'];
               	// 	$imh_poster=$fetct_raw_poster['image'];
                    ...
                    if(isset($_POST['submitbtn']))
                    {
                        ...
                        $datee =date("Y-m-d ");
                        $time=date('g:i a'); 
                         $file_vid=$_FILES["Video"]["name"];
                         $ext = pathinfo($file_vid, PATHINFO_EXTENSION);
                           if( $ext == 'mp4' || $ext == 'avi' || $ext == 'mov' || $ext == 'flv'|| $ext == 'wmv' )
                            {
                         $vid=rand(1111,9999)."_".$file_vid;
                         $pathh="video_banner/".$vid;                 
                         $tmpp=$_FILES["Video"]["tmp_name"];
                         move_uploaded_file($tmpp,$pathh);
                            ...
                            if( $ext == 'gif' || $ext == 'png' || $ext == 'jpg' || $ext == 'jpeg' || $ext =='' )
                            {
                                if($img!='')
                                {
                                    ...
                                    $pathh1="video_banner/".$foll;                            
                                    $tmpp=$_FILES["image"]["tmp_name"];
                                    //$del_img = "video_banner/".$fetct_raw_poster['image'];
                                    //unlink($del_img);
                                }else{
                                	$foll=$imh_poster;
                                }
                                ...
                                $update_sql=mysqli_query($conn,"UPDATE video_banner SET banner='$foll',url='$video' WHERE id='1'");
                ...
                <?php
                      echo '<meta http-equiv="refresh" content="1;url=manage_video_banner.php">';
                  }else{
                ?>
              ...
              <form id="personal-info" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <img src="video_banner/<?=$imh_poster?>" id="image" width="100" height="200" class="form-control">
                        <!--<img src="static_banner/<?=$fetct_raw_poster['image'];?>" id="image" width="100" height="200" class="form-control">-->
                    </div>
                </div>
                
                 <div class="form-group row">
                    <label for="input-5" class="col-sm-2 col-form-label">Upload Poster Video</label>
                    <div class="col-sm-6">
                        <input type="file" name="Video" id="Video"  class="form-control" placeholder="Product Amount" >
                        <!--<span>Image Size Should Be 120 x 400</span>-->
                    </div>
                    <div class="col-sm-4">
                        <video width="330" controls height="150px">
						  <source src="video_banner/<?=$fetct_raw_poster['url']?>" type="video/mp4">
