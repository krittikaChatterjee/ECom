  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row pt-2 pb-2">
        <div class="col-sm-9">
          <h4 class="page-title">Esencial Banner </h4>
          <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
              <li class="breadcrumb-item">Esencial Banner</li>
              <li class="breadcrumb-item active" aria-current="page">Esencial Banner </li>
           </ol>
       </div>
      </div><!-- End Breadcrumb-->
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i> Esencial Banner</div>
            <div class="card-body">
              <div class="table-responsive">
                <table id="default-datatable" class="table table-bordered">
                  ...
                  <?php
                    ...
                    $c=1;
                    $sql="SELECT * FROM `esecintial_banner` ORDER BY id DESC";
                  ...
                  ?>
                    <tr>
                      ...
                      <td><img src="esecintal_banner/<?php echo $poster;  ?>" alt="" class="img_posert">  </td>

                     <!--<td><?php echo $row['use_for'];  ?></td>-->
                   
                      <td><a href="edit_ecen_baner.php?i=<?php echo base64_encode($id); ?>"><i aria-hidden="true" class="fa fa-edit"></i></td>
