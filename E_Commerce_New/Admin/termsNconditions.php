<?php 
 ...
 $check_sql = mysqli_query($conn,"SELECT * FROM `termsNconditions`");
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row pt-2 pb-2">
        <div class="col-sm-9">
          <h4 class="page-title">Manage Terms & Conditions</h4>
          <ol class="breadcrumb">
            ...
            <div class="card-body">
                <?php
                    if(isset($_POST['submitbtn']))
                    {
                        ...
                        if(mysqli_num_rows($check_sql) > 0){
                            $sql = "UPDATE `termsNconditions` SET `heading`='$heading',`texttt`='$texttt'";
                        } else {
                            $sql = "INSERT INTO `termsNconditions`(`heading`, `texttt`) VALUES ('$heading','$texttt')";
                        }
                ...
                <div class="alert alert-success alert-dismissible" role="alert">
                    ...
                    <div class="alert-message">
                        <span><center><strong> Success !!! Terms & Conditions Updated Successfully </strong></center></span>
                    </div>
                </div>
                <?php
                      echo '<meta http-equiv="refresh" content="2;url=termsNconditions.php">';
                  }else{
                ?>
