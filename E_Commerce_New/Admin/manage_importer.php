  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row pt-2 pb-2">
        <div class="col-sm-9">
          <h4 class="page-title">Manage Importer</h4>
          <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
              <li class="breadcrumb-item">Importer</li>
              <li class="breadcrumb-item active" aria-current="page">Manage Importer</li>
           </ol>
       </div>
      </div><!-- End Breadcrumb-->
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i> Importer</div>
            <div class="card-body">
                ...
                <table id="default-datatable" class="table table-bordered">
                  ...
                  <?php
                    if(isset($_REQUEST['del']))
                    {
                      ...
                      $delete_query=mysqli_query($conn,"DELETE FROM `importer` WHERE `importer_id`='$del_id'");
                      if($delete_query)
                      {
                    ...
                    $c=1;
                    $sql="SELECT * FROM importer ORDER BY importer_id DESC";
                  ...
                  ?>
                    <tr>
                      ...
                      if($row['status'] == 'Y')
                            {
                        ?>
                        <td><button type="button" class="btn btn-success status_<?=$row['importer_id']?>" onclick="change_status(<?=$row['importer_id']?>)">Active</td>
                        <?php
                            }
                            else
                            {
                        ?>
                        <td><button type="button" class="btn btn-danger status_<?=$row['importer_id']?>" onclick="change_status(<?=$row['importer_id']?>)">Deactive</td>
                        <?php
                            }
                        ?>
