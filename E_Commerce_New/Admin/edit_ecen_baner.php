  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row pt-2 pb-2">
        <div class="col-sm-9">
          <h4 class="page-title">Dashboard Banner</h4>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="#">Dashboard Banner</a></li>
            <li class="breadcrumb-item active" aria-current="page"> Edit Dashboard Banner</li>
         </ol>
       </div>
     </div><!-- End Breadcrumb-->
          ...
          <div class="card">
            <div class="card-body">
               ...
               if(isset($_REQUEST['i'])){
               	...
               	$fetch_post=mysqli_query($conn,"SELECT * FROM esecintial_banner WHERE id='$edit'");
                        ...
                        $time=date('g:i a'); 
                            ...
                            if( $ext == 'gif' || $ext == 'png' || $ext == 'jpg' || $ext == 'jpeg' || $ext =='' )
                            {
                                if($img!='')
                                {
                                    ...
                                    $pathh1="esecintal_banner/".$foll;                            
                                    $tmpp=$_FILES["image"]["tmp_name"];
                                    $del_img = "esecintal_banner/".$fetct_raw_poster['image'];
                                    unlink($del_img);
                                }else{
                                	$foll=$imh_poster;
                                }
                                ...
                                $update_sql=mysqli_query($conn,"UPDATE esecintial_banner SET image='$foll' WHERE id='$edit'");
                ...
                <?php
                      echo '<meta http-equiv="refresh" content="2;url=manage_escenial_slider.php">';
                  }else{
                ?>
              ...
              <form id="personal-info" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <img src="esecintal_banner/<?=$fetct_raw_poster['image'];?>" id="image" width="100" height="200" class="form-control">
                    </div>
                </div>
