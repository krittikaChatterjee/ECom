          ...
          <div class="card">
            <div class="card-body">
               ...
               if(isset($_REQUEST['i'])){
               	...
               	$fetch_post=mysqli_query($conn,"SELECT * FROM static_banar WHERE id='$edit'");
                        ...
                        $time=date('g:i a'); 
                            ...
                            if( $ext == 'gif' || $ext == 'png' || $ext == 'jpg' || $ext == 'jpeg' || $ext =='' )
                            {
                                if($img!='')
                                {
                                    ...
                                    $pathh1="static_banner/".$foll;                            
                                    $tmpp=$_FILES["image"]["tmp_name"];
                                    $del_img = "static_banner/".$fetct_raw_poster['image'];
                                    unlink($del_img);
                                }else{
                                	$foll=$imh_poster;
                                }
                                ...
                                $update_sql=mysqli_query($conn,"UPDATE static_banar SET image='$foll' WHERE id='$edit'");
                ...
                <?php
                      echo '<meta http-equiv="refresh" content="2;url=manage_static_banar.php">';
                  }else{
                ?>
