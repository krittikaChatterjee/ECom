<?php 
 ...
 $check_sql = mysqli_query($conn,"SELECT * FROM `refund_policy`");
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row pt-2 pb-2">
        <div class="col-sm-9">
          <h4 class="page-title">Manage Refund & Return Policy</h4>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
            <li class="breadcrumb-item active" aria-current="page">Manage Refund & Return Policy</li>
         </ol>
       </div>
     </div><!-- End Breadcrumb-->
            ...
            <div class="card-body">
                <?php
                    if(isset($_POST['submitbtn']))
                    {
                        ...
                        if(mysqli_num_rows($check_sql) > 0){
                            $sql = "UPDATE `refund_policy` SET `heading`='$heading',`texttt`='$texttt'";
                        } else {
                            $sql = "INSERT INTO `refund_policy`(`heading`, `texttt`) VALUES ('$heading','$texttt')";
                        }
                ...
                <div class="alert alert-success alert-dismissible" role="alert">
                    ...
                    <div class="alert-message">
                        <span><center><strong> Success !!! Refund & Return Policy Updated Successfully </strong></center></span>
                    </div>
                </div>
                <?php
                      echo '<meta http-equiv="refresh" content="2;url=refund_policy.php">';
                  }else{
                ?>
