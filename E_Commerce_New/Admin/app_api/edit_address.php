<?php
    ...
    $da_id = mysqli_real_escape_string($conn,$_REQUEST['da_id']);
    ...
    if($pin_chk_row != 0){
	    ...
	    $address_query = mysqli_query($conn,"UPDATE `user_delivery_address` SET `name`='$name',`mobile`='$mobile',`city`='$city',`state`='$state',`house_no`='$houseNo',`street`='$street',`pin_code`='$pinCode',`landmark`='$landmark',`selected`=1 WHERE `da_id`='$da_id'");
