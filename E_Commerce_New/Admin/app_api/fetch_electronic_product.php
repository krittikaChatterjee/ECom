<?php
    ...
    $product_query = mysqli_query($conn,"SELECT * FROM `product` WHERE `electronic_product`='Y' AND `status`='Y' ORDER BY `product_id` DESC LIMIT 5");
