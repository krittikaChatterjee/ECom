  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row pt-2 pb-2">
        <div class="col-sm-9">
          <h4 class="page-title">Whole Seller </h4>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="#">Whole Seller</a></li>
            <li class="breadcrumb-item active" aria-current="page"> Add Whole Seller</li>
         </ol>
       </div>
     </div><!-- End Breadcrumb-->
            ...
            <div class="card-body">
                <?php
                    if(isset($_POST['submitbtn']))
                    {
                        ...
                        $check_query="SELECT * FROM `wholeseller` WHERE `email`='$email'";
                ...
                <?php
                            echo '<meta http-equiv="refresh" content="2;url=add_whole_seller.php">';
                        }
                        else
                        {
                            $insert_query=mysqli_query($conn,"INSERT INTO `wholeseller`(`name`, `email`, `password`) VALUES ('$name','$email','$password2')");
                            if($insert_query)
                            {
                                ?>
                                 <div class="alert alert-success alert-dismissible" role="alert">
