      ...
      <div class="row pt-2 pb-2">
        <div class="col-sm-9">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#">Importer</a></li>
            <li class="breadcrumb-item active" aria-current="page"> Add Importer</li>
         </ol>
       </div>
     </div><!-- End Breadcrumb-->
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
                ...
                <?php
                            echo '<meta http-equiv="refresh" content="2;url=add_importer.php">';
                        }
                        else
                        {
                            $insert_query=mysqli_query($conn,"INSERT INTO `importer`(`name`, `email`, `password`) VALUES ('$name','$email','$password2')");
                            if($insert_query)
                            {
                                ?>
                                 <div class="alert alert-success alert-dismissible" role="alert">
