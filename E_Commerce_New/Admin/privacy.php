<?php 
 ...
 $check_sql = mysqli_query($conn,"SELECT * FROM `privacy_policy`");
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="row pt-2 pb-2">
        <div class="col-sm-9">
          <h4 class="page-title">Manage Privacy Policy</h4>
          <ol class="breadcrumb">
            ...
            <div class="card-body">
                <?php
                    if(isset($_POST['submitbtn']))
                    {
                        ...
                        if(mysqli_num_rows($check_sql) > 0){
                            $sql = "UPDATE `privacy_policy` SET `heading`='$heading',`texttt`='$texttt'";
                        } else {
                            $sql = "INSERT INTO `privacy_policy`(`heading`, `texttt`) VALUES ('$heading','$texttt')";
                        }
                ...
                <div class="alert alert-success alert-dismissible" role="alert">
                    ...
                    <div class="alert-message">
                        <span><center><strong> Success !!! Privacy Policy Updated Successfully </strong></center></span>
                    </div>
                </div>
                <?php
