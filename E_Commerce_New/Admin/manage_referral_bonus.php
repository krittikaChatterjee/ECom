<?php 
 ...
 ?>
<?php
    $view_query = mysqli_query($conn,"SELECT * FROM `referral_bonus` WHERE `rb_id`='1'");
            ...
            <div class="card-body">
              ...
              <form id="personal-info" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <label for="input-5" class="col-sm-2 col-form-label">Join Bonus</label>
                    <div class="col-sm-6">
                        <input type="text" name="join_bonus" id="join_bonus" value="<?=$view_result['rb_amount']?>" class="form-control" placeholder="Join Bonus"  required>
                ...
                <div class="form-group row">
                    <label for="input-5" class="col-sm-2 col-form-label">Referral Bonus</label>
                    <div class="col-sm-6">
                        <input type="text" name="referral_bonus" id="referral_bonus" value="<?=$view_result['rb_under_user_amount']?>" class="form-control" placeholder="Referral Bonus"  required>
                    </div>
