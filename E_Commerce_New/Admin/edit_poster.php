...
$fetch_post=mysqli_query($conn,"SELECT * FROM poster WHERE poster_id='$edit'");
$fetct_raw_poster=mysqli_fetch_assoc($fetch_post);
$imh_poster=$fetct_raw_poster['name'];
}
?>
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    if( $ext == 'gif' || $ext == 'png' || $ext == 'jpg' || $ext == 'jpeg' || $ext =='' ){
                        ...
                        $del_img = "poster_image/".$fetct_raw_poster['name'];
                        unlink($del_img);
                        }
                        else{
                            $foll=$imh_poster;
                        ...
                        $update_sql=mysqli_query($conn,"UPDATE poster SET name='$foll',title='$title',description='$description',date='$datee',time='$time' WHERE poster_id='$edit'");
                        if($update_sql){
                ...
                <div class="alert alert-success alert-dismissible" role="alert">
                    ...
                    <div class="alert-message">
                        <span><center><strong> Success !!! Poster Inserted Successfully </strong></center></span>
                    </div>
                </div>
                <?php
                    echo '<meta http-equiv="refresh" content="2;url=manage_poster.php">';
                  }else{
                ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="title" id="title" value="<?=$fetct_raw_poster['title']?>" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <textarea type="text" name="description" id="description" class="form-control"><?=$fetct_raw_poster['description']?></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <img src="poster_image/<?=$fetct_raw_poster['name']?>" id="image" width="100" height="200" class="form-control">
                    </div>
                </div>
