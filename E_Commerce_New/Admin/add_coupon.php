            ...
            <div class="card-body">
                <?php
                    if(isset($_POST['submitbtn']))
                    {
                        ...
                        $check_query="SELECT * FROM `coupon` WHERE `coupon_name`='$cupon_name'";
                ...
                <div class="alert alert-info alert-dismissible" role="alert">
                    ...
                    <div class="alert-message">
                      <span><center><strong> Sorry!! Coupon Already Exist.. </strong></center></span>
                    </div>
                </div>
                <?php
                            echo '<meta http-equiv="refresh" content="2;url=add_coupon.php">';
                        }
                        else
                        {
                                    ...
                                    echo $sql="INSERT INTO `coupon`( `coupon_name`,`dis_per`,`status`) VALUES ('$cupon_name','$dis_percentsge','Y')";
                ...
                <div class="alert alert-success alert-dismissible" role="alert">
                    ...
                    <div class="alert-message">
                        <span><center><strong> Success !!! Coupon Inserted Successfully </strong></center></span>
                    </div>
                </div>
                <?php
                    echo '<meta http-equiv="refresh" content="2;url=add_coupon.php">';
              ...
              <form id="personal-info" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="cupon_name" class="form-control" placeholder="Coupon Name" required>
               ...
               <!-- <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="number" name="dis_percentsge"  class="form-control" required placeholder="Discount Amount">
                  </div>
                </div>
